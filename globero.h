...
class Globero: public _2D::ObjetoMovil{
	...
	public:
		...
		void dibujar();
		void iterar();
		Globero(const _2D::Rectangulo<double>& pos, Imagen * r, Color f = Color::negro , const _2D::Punto<double> v = _2D::Punto<double>(), const _2D::Punto<double> a = _2D::Punto<double>()):_2D::ObjetoMovil(pos, r, f, v, a){
...
void Globero::iterar(){
	...
	if((int)floor(posicion.inicio.y)==0){
		suelo = true;
	}
}
